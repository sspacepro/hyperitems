//package org.galaxystudios.hyperitems.unusedfn;
//
...
//        Plugin plugin = Bukkit.getPluginManager().getPlugin("De");
//        if (plugin == null) {
//            Bukkit.getLogger().warning("[D] Plugin instance not found!");
//            return;
//        }
//
...
//        if (items == null) {
//            Bukkit.getLogger().warning("[De] No items found in items.yml");
//            return;
//        }
//
//        loadedItems.clear();
...
//                if (material == null) {
//                    Bukkit.getLogger().warning("[Dute] Invalid material for item: " + key);
//                    continue;
//                }
//
...
//
//                Bukkit.getLogger().info("[reate] Loaded custom item: " + key);
//            } catch (Exception e) {
//                Bukkit.getLogger().warning("[ate] Failed to load item '" + key + "': " + e.getMessage());
//                e.printStackTrace();
//            }
//        }
//    }
...
//                        } else {
//                            Bukkit.getLogger().warning("[Date] Invalid ingredient for item " + key + ": " + itemName);
//                        }
//                    }
//
...
//                }
//
//                default -> Bukkit.getLogger().warning("[te] Unknown recipe type for " + key + ": " + type);
//            }
//        } catch (Exception e) {
//            Bukkit.getLogger().warning("[te] Failed to register recipe for " + key + ": " + e.getMessage());
//            e.printStackTrace();
//        }
//    }
//}
